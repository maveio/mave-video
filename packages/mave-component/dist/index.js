var k=Object.defineProperty;var x=Object.getOwnPropertyDescriptor;var _=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,S=Object.prototype.propertyIsEnumerable;var w=(o,r,e)=>r in o?k(o,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):o[r]=e,E=(o,r)=>{for(var e in r||(r={}))T.call(r,e)&&w(o,e,r[e]);if(_)for(var e of _(r))S.call(r,e)&&w(o,e,r[e]);return o};var i=(o,r,e,t)=>{for(var a=t>1?void 0:t?x(r,e):r,l=o.length-1,c;l>=0;l--)(c=o[l])&&(a=(t?c(r,e,a):c(a))||a);return t&&a&&k(r,e,a),a};var d=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return d._inst||(d._inst=new d),d._inst}get baseUrl(){return this._baseUrl}set baseUrl(r){this._baseUrl=r}};import{html as g,LitElement as D}from"lit";import{property as n,query as p,state as b}from"lit/decorators.js";import{css as A}from"lit";var $=A`
  dialog {
    position: relative;
    display: flex;
    float: left;
...
`;import{decode as P}from"@fpapado/blurhash";import{html as L,css as F,LitElement as U}from"lit";import{property as z,query as H,state as f}from"lit/decorators.js";var h=class extends U{constructor(){super(...arguments);this._ghostActive=!0;this._loaded=!0;this._delayed=!1}connectedCallback(){var e;super.connectedCallback(),setTimeout(()=>{this._delayed=!0},250),this._globalStyle=document.documentElement.getAttribute("style")||"",document.documentElement.setAttribute("style",`${this._globalStyle}; padding-right: 14rem; transition: padding 150ms; transition-timing-function: cubic-bezier(0, 0, 0.2, 1);`),setTimeout(()=>{this._ghostActive=!0,this.dialog.showModal()},0),(e=this.iframe)==null||e.addEventListener("load",this.iframeLoaded.bind(this))}disconnectedCallback(){var e;document.documentElement.setAttribute("style",this._globalStyle||""),(e=this.iframe)==null||e.removeEventListener("load",this.iframeLoaded.bind(this)),this.dialog.close(),super.disconnectedCallback()}dialogHandler(e){e.type=="close"&&window.postMessage({message:"mave:close_settings",hash:this.embed},"*"),e.target==this.dialog&&this.dialog.close()}render(){return L`
      <dialog
        id="dialog"
