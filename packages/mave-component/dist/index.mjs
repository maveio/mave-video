var k=Object.defineProperty;var H=Object.getOwnPropertyDescriptor;var _=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,x=Object.prototype.propertyIsEnumerable;var w=(l,r,e)=>r in l?k(l,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[r]=e,E=(l,r)=>{for(var e in r||(r={}))T.call(r,e)&&w(l,e,r[e]);if(_)for(var e of _(r))x.call(r,e)&&w(l,e,r[e]);return l};var i=(l,r,e,t)=>{for(var a=t>1?void 0:t?H(r,e):r,n=l.length-1,c;n>=0;n--)(c=l[n])&&(a=(t?c(r,e,a):c(a))||a);return t&&a&&k(r,e,a),a};var d=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return d._inst||(d._inst=new d),d._inst}get baseUrl(){return this._baseUrl}set baseUrl(r){this._baseUrl=r}};import{html as g,LitElement as P}from"lit";import{property as o,query as u,state as f}from"lit/decorators.js";import{css as S}from"lit";var $=S`
  dialog {
    position: relative;
    display: flex;
    float: left;
...
`;import{decode as j}from"@fpapado/blurhash";import{html as L,css as A,LitElement as F}from"lit";import{property as U,query as z,state as b}from"lit/decorators.js";var h=class extends F{constructor(){super(...arguments);this._ghostActive=!0;this._loaded=!0;this._delayed=!1}connectedCallback(){var e;super.connectedCallback(),setTimeout(()=>{this._delayed=!0},250),this._globalStyle=document.documentElement.getAttribute("style")||"",document.documentElement.setAttribute("style",`${this._globalStyle}; padding-right: 14rem; transition: padding 150ms; transition-timing-function: cubic-bezier(0, 0, 0.2, 1);`),setTimeout(()=>{this._ghostActive=!0},0),(e=this.iframe)==null||e.addEventListener("load",this.iframeLoaded.bind(this))}disconnectedCallback(){var e;document.documentElement.setAttribute("style",this._globalStyle||""),(e=this.iframe)==null||e.removeEventListener("load",this.iframeLoaded.bind(this)),super.disconnectedCallback()}render(){return L`
      <div>
