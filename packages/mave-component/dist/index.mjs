var w=Object.defineProperty;var H=Object.getOwnPropertyDescriptor;var y=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,x=Object.prototype.propertyIsEnumerable;var _=(l,r,e)=>r in l?w(l,r,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[r]=e,k=(l,r)=>{for(var e in r||(r={}))T.call(r,e)&&_(l,e,r[e]);if(y)for(var e of y(r))x.call(r,e)&&_(l,e,r[e]);return l};var i=(l,r,e,t)=>{for(var s=t>1?void 0:t?H(r,e):r,n=l.length-1,c;n>=0;n--)(c=l[n])&&(s=(t?c(r,e,s):c(s))||s);return t&&s&&w(r,e,s),s};var o=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return o._inst||(o._inst=new o),o._inst}get baseUrl(){return this._baseUrl}set baseUrl(r){this._baseUrl=r}};import{html as u,LitElement as z}from"lit";import{property as d,query as p,state as g}from"lit/decorators.js";import{css as S}from"lit";var E=S`
  dialog {
    position: relative;
    display: flex;
    float: left;
