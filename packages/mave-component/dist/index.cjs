var g=Object.defineProperty;var w=Object.getOwnPropertyDescriptor;var T=Object.getOwnPropertyNames,y=Object.getOwnPropertySymbols;var k=Object.prototype.hasOwnProperty,L=Object.prototype.propertyIsEnumerable;var _=(l,i,e)=>i in l?g(l,i,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[i]=e,E=(l,i)=>{for(var e in i||(i={}))k.call(i,e)&&_(l,e,i[e]);if(y)for(var e of y(i))L.call(i,e)&&_(l,e,i[e]);return l};var S=(l,i)=>{for(var e in i)g(l,e,{get:i[e],enumerable:!0})},A=(l,i,e,t)=>{if(i&&typeof i=="object"||typeof i=="function")for(let s of T(i))!k.call(l,s)&&s!==e&&g(l,s,{get:()=>i[s],enumerable:!(t=w(i,s))||t.enumerable});return l};var F=l=>A(g({},"__esModule",{value:!0}),l),a=(l,i,e,t)=>{for(var s=t>1?void 0:t?w(i,e):i,n=l.length-1,c;n>=0;n--)(c=l[n])&&(s=(t?c(i,e,s):c(s))||s);return t&&s&&g(i,e,s),s};var z={};S(z,{Config:()=>d,MaveComponent:()=>r});module.exports=F(z);var d=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return d._inst||(d._inst=new d),d._inst}get baseUrl(){return this._baseUrl}set baseUrl(i){this._baseUrl=i}};var u=require("lit"),o=require("lit/decorators.js");var $=require("lit"),H=$.css`
  dialog {
    position: relative;
    display: flex;
    float: left;
