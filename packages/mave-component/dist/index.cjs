var g=Object.defineProperty,A=Object.defineProperties,w=Object.getOwnPropertyDescriptor,F=Object.getOwnPropertyDescriptors,L=Object.getOwnPropertyNames,y=Object.getOwnPropertySymbols;var k=Object.prototype.hasOwnProperty,V=Object.prototype.propertyIsEnumerable;var _=(l,s,e)=>s in l?g(l,s,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[s]=e,E=(l,s)=>{for(var e in s||(s={}))k.call(s,e)&&_(l,e,s[e]);if(y)for(var e of y(s))V.call(s,e)&&_(l,e,s[e]);return l},H=(l,s)=>A(l,F(s));var U=(l,s)=>{for(var e in s)g(l,e,{get:s[e],enumerable:!0})},P=(l,s,e,t)=>{if(s&&typeof s=="object"||typeof s=="function")for(let i of L(s))!k.call(l,i)&&i!==e&&g(l,i,{get:()=>s[i],enumerable:!(t=w(s,i))||t.enumerable});return l};var z=l=>P(g({},"__esModule",{value:!0}),l),a=(l,s,e,t)=>{for(var i=t>1?void 0:t?w(s,e):s,o=l.length-1,c;o>=0;o--)(c=l[o])&&(i=(t?c(s,e,i):c(i))||i);return t&&i&&g(s,e,i),i};var I={};U(I,{Config:()=>h,MaveComponent:()=>r});module.exports=z(I);var h=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return h._inst||(h._inst=new h),h._inst}get baseUrl(){return this._baseUrl}set baseUrl(s){this._baseUrl=s}};var d=require("lit"),S=require("lit/directives/ref.js"),n=require("lit/decorators.js");var $=require("lit"),x=$.css`
  :root {
