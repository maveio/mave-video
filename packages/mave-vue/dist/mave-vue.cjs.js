"use strict";require("vue");var m=Object.defineProperty,g=Object.getOwnPropertyDescriptor,w=Object.getOwnPropertyNames,y=Object.getOwnPropertySymbols,_=Object.prototype.hasOwnProperty,k=Object.prototype.propertyIsEnumerable,b=(e,i,t)=>i in e?m(e,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[i]=t,$=(e,i)=>{for(var t in i||(i={}))_.call(i,t)&&b(e,t,i[t]);if(y)for(var t of y(i))k.call(i,t)&&b(e,t,i[t]);return e},E=(e,i)=>{for(var t in i)m(e,t,{get:i[t],enumerable:!0})},x=(e,i,t,n)=>{if(i&&typeof i=="object"||typeof i=="function")for(let o of w(i))!_.call(e,o)&&o!==t&&m(e,o,{get:()=>i[o],enumerable:!(n=g(i,o))||n.enumerable});return e},S=e=>x(m({},"__esModule",{value:!0}),e),s=(e,i,t,n)=>{for(var o=n>1?void 0:n?g(i,t):i,c=e.length-1,l;c>=0;c--)(l=e[c])&&(o=(n?l(i,t,o):l(o))||o);return n&&o&&m(i,t,o),o},f={};E(f,{Config:()=>h,MaveComponent:()=>a});module.exports=S(f);var h=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return h._inst||(h._inst=new h),h._inst}get baseUrl(){return this._baseUrl}set baseUrl(e){this._baseUrl=e}},v=require("lit"),r=require("lit/decorators.js"),T=require("lit"),H=T.css`
  dialog {
    position: relative;
    display: flex;
    float: left;
...
`,A=require("@fpapado/blurhash"),u=require("lit"),p=require("lit/decorators.js"),d=class extends u.LitElement{constructor(){super(...arguments),this._ghostActive=!0,this._loaded=!0,this._delayed=!1}connectedCallback(){var e;super.connectedCallback(),setTimeout(()=>{this._delayed=!0},250),this._globalStyle=document.documentElement.getAttribute("style")||"",document.documentElement.setAttribute("style",`${this._globalStyle}; padding-right: 14rem; transition: padding 150ms; transition-timing-function: cubic-bezier(0, 0, 0.2, 1);`),setTimeout(()=>{this._ghostActive=!0},0),(e=this.iframe)==null||e.addEventListener("load",this.iframeLoaded.bind(this))}disconnectedCallback(){var e;document.documentElement.setAttribute("style",this._globalStyle||""),(e=this.iframe)==null||e.removeEventListener("load",this.iframeLoaded.bind(this)),super.disconnectedCallback()}render(){return u.html`
      <div>
    ...
    `}iframeLoaded(){this._loaded=!0}};d.styles=u.css`
    .ghost {
