 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var G;const x=globalThis.trustedTypes,le=x?x.createPolicy("lit-html",{createHTML:i=>i}):void 0,w=`lit$${(Math.random()+"").slice(9)}$`,ae="?"+w,ke=`<${ae}>`,H=document,R=(i="")=>H.createComment(i),O=i=>i===null||typeof i!="object"&&typeof i!="function",he=Array.isArray,xe=i=>{var e;return he(i)||typeof((e=i)===null||e===void 0?void 0:e[Symbol.iterator])=="function"},L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,de=/-->/g,ce=/>/g,E=/>|[ 	\n\r](?:([^\s"'>=/]+)([ 	\n\r]*=[ 	\n\r]*(?:[^ 	\n\r"'`<>=]|("|')|))|$)/g,pe=/'/g,ue=/"/g,ve=/^(?:script|style|textarea|title)$/i,He=i=>(e,...t)=>({_$litType$:i,strings:e,values:t}),B=He(1),C=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),me=new WeakMap,Ce=(i,e,t)=>{var s,o;const n=(s=t==null?void 0:t.renderBefore)!==null&&s!==void 0?s:e;let r=n._$litPart$;if(r===void 0){const c=(o=t==null?void 0:t.renderBefore)!==null&&o!==void 0?o:null;n._$litPart$=r=new N(e.insertBefore(R(),c),c,void 0,t!=null?t:{})}return r._$AI(i),r},T=H.createTreeWalker(H,129,null,!1),Te=(i,e)=>{const t=i.length-1,s=[];let o,n=e===2?"<svg>":"",r=L;for(let l=0;l<t;l++){const a=i[l];let b,u,v=-1,f=0;for(;f<a.length&&(r.lastIndex=f,u=r.exec(a),u!==null);)f=r.lastIndex,r===L?u[1]==="!--"?r=de:u[1]!==void 0?r=ce:u[2]!==void 0?(ve.test(u[2])&&(o=RegExp("</"+u[2],"g")),r=E):u[3]!==void 0&&(r=E):r===E?u[0]===">"?(r=o!=null?o:L,v=-1):u[1]===void 0?v=-2:(v=r.lastIndex-u[2].length,b=u[1],r=u[3]===void 0?E:u[3]==='"'?ue:pe):r===ue||r===pe?r=E:r===de||r===ce?r=L:(r=E,o=void 0);const j=r===E&&i[l+1].startsWith("/>")?" ":"";n+=r===L?a+ke:v>=0?(s.push(b),a.slice(0,v)+"$lit$"+a.slice(v)+w+j):a+w+(v===-2?(s.push(void 0),l):j)}const c=n+(i[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(i)||!i.hasOwnProperty("raw"))throw Error("invalid template strings array");return[le!==void 0?le.createHTML(c):c,s]};class F{constructor({strings:e,_$litType$:t},s){let o;this.parts=[];let n=0,r=0;const c=e.length-1,l=this.parts,[a,b]=Te(e,t);if(this.el=F.createElement(a,s),T.currentNode=this.el.content,t===2){const u=this.el.content,v=u.firstChild;v.remove(),u.append(...v.childNodes)}for(;(o=T.nextNode())!==null&&l.length<c;){if(o.nodeType===1){if(o.hasAttributes()){const u=[];for(const v of o.getAttributeNames())if(v.endsWith("$lit$")||v.startsWith(w)){const f=b[r++];if(u.push(v),f!==void 0){const j=o.getAttribute(f.toLowerCase()+"$lit$").split(w),V=/([.?@])?(.*)/.exec(f);l.push({type:1,index:n,name:V[2],strings:j,ctor:V[1]==="."?Pe:V[1]==="?"?Re:V[1]==="@"?Oe:z})}else l.push({type:6,index:n})}for(const v of u)o.removeAttribute(v)}if(ve.test(o.tagName)){const u=o.textContent.split(w),v=u.length-1;if(v>0){o.textContent=x?x.emptyScript:"";for(let f=0;f<v;f++)o.append(u[f],R()),T.nextNode(),l.push({type:2,index:++n});o.append(u[v],R())}}}else if(o.nodeType===8)if(o.data===ae)l.push({type:2,index:n});else{let u=-1;for(;(u=o.data.indexOf(w,u+1))!==-1;)l.push({type:7,index:n}),u+=w.length-1}n++}}static createElement(e,t){const s=H.createElement("template");return s.innerHTML=e,s}}function U(i,e,t=i,s){var o,n,r,c;if(e===C)return e;let l=s!==void 0?(o=t._$Cl)===null||o===void 0?void 0:o[s]:t._$Cu;const a=O(e)?void 0:e._$litDirective$;return(l==null?void 0:l.constructor)!==a&&((n=l==null?void 0:l._$AO)===null||n===void 0||n.call(l,!1),a===void 0?l=void 0:(l=new a(i),l._$AT(i,t,s)),s!==void 0?((r=(c=t)._$Cl)!==null&&r!==void 0?r:c._$Cl=[])[s]=l:t._$Cu=l),l!==void 0&&(e=U(i,l._$AS(i,e.values),l,s)),e}class Ue{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:s},parts:o}=this._$AD,n=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:H).importNode(s,!0);T.currentNode=n;let r=T.nextNode(),c=0,l=0,a=o[0];for(;a!==void 0;){if(c===a.index){let b;a.type===2?b=new N(r,r.nextSibling,this,e):a.type===1?b=new a.ctor(r,a.name,a.strings,this,e):a.type===6&&(b=new Le(r,this,e)),this.v.push(b),a=o[++l]}c!==(a==null?void 0:a.index)&&(r=T.nextNode(),c++)}return n}m(e){let t=0;for(const s of this.v)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,t),t+=s.strings.length-2):s._$AI(e[t])),t++}}class N{constructor(e,t,s,o){var n;this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=s,this.options=o,this._$Cg=(n=o==null?void 0:o.isConnected)===null||n===void 0||n}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$Cg}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=U(this,e,t),O(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==C&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):xe(e)?this.S(e):this.$(e)}M(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.M(e))}$(e){this._$AH!==m&&O(this._$AH)?this._$AA.nextSibling.data=e:this.k(H.createTextNode(e)),this._$AH=e}T(e){var t;const{values:s,_$litType$:o}=e,n=typeof o=="number"?this._$AC(e):(o.el===void 0&&(o.el=F.createElement(o.h,this.options)),o);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===n)this._$AH.m(s);else{const r=new Ue(n,this),c=r.p(this.options);r.m(s),this.k(c),this._$AH=r}}_$AC(e){let t=me.get(e.strings);return t===void 0&&me.set(e.strings,t=new F(e)),t}S(e){he(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let s,o=0;for(const n of e)o===t.length?t.push(s=new N(this.M(R()),this.M(R()),this,this.options)):s=t[o],s._$AI(n),o++;o<t.length&&(this._$AR(s&&s._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var s;for((s=this._$AP)===null||s===void 0||s.call(this,!1,!0,t);e&&e!==this._$AB;){const o=e.nextSibling;e.remove(),e=o}}setConnected(e){var t;this._$AM===void 0&&(this._$Cg=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class z{constructor(e,t,s,o,n){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=n,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,s,o){const n=this.strings;let r=!1;if(n===void 0)e=U(this,e,t,0),r=!O(e)||e!==this._$AH&&e!==C,r&&(this._$AH=e);else{const c=e;let l,a;for(e=n[0],l=0;l<n.length-1;l++)a=U(this,c[s+l],t,l),a===C&&(a=this._$AH[l]),r||(r=!O(a)||a!==this._$AH[l]),a===m?e=m:e!==m&&(e+=(a!=null?a:"")+n[l+1]),this._$AH[l]=a}r&&!o&&this.C(e)}C(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class Pe extends z{constructor(){super(...arguments),this.type=3}C(e){this.element[this.name]=e===m?void 0:e}}const Me=x?x.emptyScript:"";class Re extends z{constructor(){super(...arguments),this.type=4}C(e){e&&e!==m?this.element.setAttribute(this.name,Me):this.element.removeAttribute(this.name)}}class Oe extends z{constructor(e,t,s,o,n){super(e,t,s,o,n),this.type=5}_$AI(e,t=this){var s;if((e=(s=U(this,e,t,0))!==null&&s!==void 0?s:m)===C)return;const o=this._$AH,n=e===m&&o!==m||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,r=e!==m&&(o===m||n);n&&this.element.removeEventListener(this.name,this,o),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,s;typeof this._$AH=="function"?this._$AH.call((s=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&s!==void 0?s:this.element,e):this._$AH.handleEvent(e)}}class Le{constructor(e,t,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}}const ge=window.litHtmlPolyfillSupport;ge==null||ge(F,N),((G=globalThis.litHtmlVersions)!==null&&G!==void 0?G:globalThis.litHtmlVersions=[]).push("2.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Q,X;class P extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Dt=void 0}createRenderRoot(){var e,t;const s=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=s.firstChild),s}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Dt=Ce(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Dt)===null||e===void 0||e.setConnected(!1)}render(){return C}}P.finalized=!0,P._$litElement$=!0,(Q=globalThis.litElementHydrateSupport)===null||Q===void 0||Q.call(globalThis,{LitElement:P});const _e=globalThis.litElementPolyfillSupport;_e==null||_e({LitElement:P}),((X=globalThis.litElementVersions)!==null&&X!==void 0?X:globalThis.litElementVersions=[]).push("3.2.0");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
