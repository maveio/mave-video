(function(d){typeof define=="function"&&define.amd?define(["vue"],d):d()})(function(){"use strict";var d=Object.defineProperty,y=Object.getOwnPropertyDescriptor,w=Object.getOwnPropertyNames,b=Object.getOwnPropertySymbols,g=Object.prototype.hasOwnProperty,k=Object.prototype.propertyIsEnumerable,f=(e,i,t)=>i in e?d(e,i,{enumerable:!0,configurable:!0,writable:!0,value:t}):e[i]=t,$=(e,i)=>{for(var t in i||(i={}))g.call(i,t)&&f(e,t,i[t]);if(b)for(var t of b(i))k.call(i,t)&&f(e,t,i[t]);return e},E=(e,i)=>{for(var t in i)d(e,t,{get:i[t],enumerable:!0})},S=(e,i,t,n)=>{if(i&&typeof i=="object"||typeof i=="function")for(let o of w(i))!g.call(e,o)&&o!==t&&d(e,o,{get:()=>i[o],enumerable:!(n=y(i,o))||n.enumerable});return e},x=e=>S(d({},"__esModule",{value:!0}),e),s=(e,i,t,n)=>{for(var o=n>1?void 0:n?y(i,t):i,p=e.length-1,l;p>=0;p--)(l=e[p])&&(o=(n?l(i,t,o):l(o))||o);return n&&o&&d(i,t,o),o},_={};E(_,{Config:()=>h,MaveComponent:()=>a}),module.exports=x(_);var h=class{constructor(){this._baseUrl="mave.io"}static getInstance(){return h._inst||(h._inst=new h),h._inst}get baseUrl(){return this._baseUrl}set baseUrl(e){this._baseUrl=e}},m=require("lit"),r=require("lit/decorators.js"),H=require("lit"),T=H.css`
  dialog {
    position: relative;
    display: flex;
    float: left;
...
`,A=require("@fpapado/blurhash"),u=require("lit"),v=require("lit/decorators.js"),c=class extends u.LitElement{constructor(){super(...arguments),this._ghostActive=!0,this._loaded=!0}connectedCallback(){var e;super.connectedCallback(),this._globalStyle=document.documentElement.getAttribute("style")||"",document.documentElement.setAttribute("style",`${this._globalStyle}; padding-right: 14rem; transition: padding 150ms; transition-timing-function: cubic-bezier(0, 0, 0.2, 1);`),setTimeout(()=>{this._ghostActive=!0},0),(e=this.iframe)==null||e.addEventListener("load",this.iframeLoaded.bind(this))}disconnectedCallback(){var e;document.documentElement.setAttribute("style",this._globalStyle||""),(e=this.iframe)==null||e.removeEventListener("load",this.iframeLoaded.bind(this)),super.disconnectedCallback()}render(){return u.html`
      <div>
